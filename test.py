...
from networks.vision_transformer import ATFormer as ViT_seg
...
parser.add_argument('--test_save_dir', type=str, default='./output/predictions', help='saving prediction as nii!')
...
if __name__ == "__main__":
    ...
    snapshot = './output/epoch_1000.pth'  # Path of weights
