...
from networks.vision_transformer import VisionTransformer as ViT_seg
...
parser.add_argument('--cfg', default=r'configs/swin_tiny_patch4_window7_224_lite.yaml',type=str, metavar="FILE", help='path to config file', )
parser.add_argument(
        "--opts",
